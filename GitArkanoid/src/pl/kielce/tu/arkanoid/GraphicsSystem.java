...
public class GraphicsSystem {
	...
	static final String[] MENU_ITEMS = {"New game", "Settings", "Quit"};
	...
	public static void showScore(GraphicsContext context) {
		context.setFill(Color.WHITE);
		context.setFont(Font.font(40));
		context.fillText("Score: " + Values.score,100,50);
	}

	public static void showEndGameScore(GraphicsContext context) {
		context.setFill(Color.WHITE);
		context.setFont(Font.font(72));
		context.fillText("Your score: " + Values.score, GraphicsSystem.width / 2, GraphicsSystem.height / 2);	
	}
